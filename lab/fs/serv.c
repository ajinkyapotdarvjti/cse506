...
serve_read(envid_t envid, union Fsipc *ipc)
{
	...
	if( (bytes_read = file_read(of->o_file, ret->ret_buf, n, of->o_fd->fd_offset)) < 0)
		return bytes_read;
...
serve_write(envid_t envid, struct Fsreq_write *req)
{
	...
	// LAB 5: Your code here.
        ...
        size_t bytes = MIN(req->req_n, sizeof(req->req_buf));

        int bytes_written = file_write(of->o_file, req->req_buf, bytes, of->o_fd->fd_offset);
